...
from SHE_SLModel_Autoarray.SHE_SLModel_Plot.SHE_SLModel_MatWrap import get_visuals as gv
...
from SHE_SLModel_Autogalaxy.SHE_SLModel_Util import error_util
...
class GetVisuals1D(gv.GetVisuals1D):
    ...
    def via_light_obj_list_from(self, light_obj_list, low_limit):
        """
    ...
    def via_mass_obj_from(self, mass_obj, grid):
        """
    ...
    def via_mass_obj_list_from(self, mass_obj_list, grid, low_limit):
        """
...
class GetVisuals2D(gv.GetVisuals2D):
    ...
    def via_light_obj_from(self, light_obj, grid):
        """
        ...
        return (self.visuals + visuals_via_mask) + self.visuals.__class__(
    ...
    def via_mass_obj_from(self, mass_obj, grid):
        ...
        return (self.visuals + visuals_via_mask) + self.visuals.__class__(
            mass_profile_centres=mass_profile_centres, critical_curves=critical_curves
        )

    def via_light_mass_obj_from(self, light_mass_obj, grid):
        """
        ...
        return (visuals_2d + visuals_with_grid) + self.via_light_obj_from(
            light_obj=light_mass_obj, grid=grid
        )

    def via_fit_imaging_from(self, fit):
        """
