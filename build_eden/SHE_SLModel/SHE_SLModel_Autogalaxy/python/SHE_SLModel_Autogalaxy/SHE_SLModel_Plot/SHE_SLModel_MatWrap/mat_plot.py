...
from SHE_SLModel_Autogalaxy.SHE_SLModel_Plot.SHE_SLModel_MatWrap import wrap as w
...
class MatPlot1D(aplt.MatPlot1D):
    def __init__(
        ...
        yx_plot=None,
        fill_between=None,
        half_light_radius_axvline=None,
        einstein_radius_axvline=None,
        model_fluxes_yx_scatter=None,
    ):
        """
