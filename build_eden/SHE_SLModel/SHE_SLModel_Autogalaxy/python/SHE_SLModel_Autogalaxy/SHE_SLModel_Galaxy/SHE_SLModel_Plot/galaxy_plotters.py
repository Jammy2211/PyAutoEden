...
import SHE_SLModel_Autoarray.SHE_SLModel_Plot as aplt
from SHE_SLModel_Autogalaxy.SHE_SLModel_Plot.abstract_plotters import Plotter
...
from SHE_SLModel_Autogalaxy.SHE_SLModel_Plot.mass_plotter import MassPlotter
...
class GalaxyPDFPlotter(GalaxyPlotter):
    ...
    def light_profile_pdf_plotter_from(self, index):
        """
    ...
    def mass_profile_pdf_plotter_from(self, index):
        """
