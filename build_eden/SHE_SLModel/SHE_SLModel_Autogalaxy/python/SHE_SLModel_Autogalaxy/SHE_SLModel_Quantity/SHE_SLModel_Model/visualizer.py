...
from SHE_SLModel_Autogalaxy.SHE_SLModel_Analysis.visualizer import plot_setting
...
class VisualizerQuantity(Visualizer):
    def visualize_fit_quantity(
        self, fit, visuals_2d=Visuals2D(), fit_quanaity_plotter_cls=FitQuantityPlotter
    ):
        """
