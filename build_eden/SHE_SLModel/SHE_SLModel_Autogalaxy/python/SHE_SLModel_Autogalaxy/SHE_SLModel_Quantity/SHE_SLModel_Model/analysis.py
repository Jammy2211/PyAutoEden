...
from SHE_SLModel_Autogalaxy.SHE_SLModel_Analysis.analysis import Analysis
from SHE_SLModel_Autogalaxy.SHE_SLModel_Quantity.SHE_SLModel_Model.visualizer import (
    VisualizerQuantity,
)
from SHE_SLModel_Autogalaxy.SHE_SLModel_Quantity.dataset_quantity import DatasetQuantity
from SHE_SLModel_Autogalaxy.SHE_SLModel_Quantity.SHE_SLModel_Model.result import (
    ResultQuantity,
)
...
class AnalysisQuantity(Analysis):
    def __init__(self, dataset, func_str, cosmology=cosmo.Planck15):
        """
