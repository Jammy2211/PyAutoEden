...
from SHE_SLModel_Autogalaxy.SHE_SLModel_Hyper.hyper_data import HyperImageSky
from SHE_SLModel_Autogalaxy.SHE_SLModel_Hyper.hyper_data import HyperBackgroundNoise
...
from SHE_SLModel_Autogalaxy.SHE_SLModel_Analysis.result import ResultDataset
...
class AnalysisDataset(Analysis):
    ...
    def associate_hyper_images(self, instance):
        """
