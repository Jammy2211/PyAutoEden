...
class SimulatorInterferometer(aa.SimulatorInterferometer):
    def __init__(
        ...
        ----------
        shape_native
            The shape of the observation. Note that we do not simulator a full Imaging frame (e.g. 2000 x 2000 pixels for             Hubble imaging), but instead just a cut-out around the strong lens.
        pixel_scales
