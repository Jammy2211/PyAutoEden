...
def _interferometer_from(fit, real_space_mask=None, settings_interferometer=None):
    """
...
class InterferometerAgg:
    ...
    def interferometer_gen(self, real_space_mask=None, settings_interferometer=None):
        """
