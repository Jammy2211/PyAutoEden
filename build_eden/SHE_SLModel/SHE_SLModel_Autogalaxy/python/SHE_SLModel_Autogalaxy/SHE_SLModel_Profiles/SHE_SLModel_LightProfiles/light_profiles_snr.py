...
class LightProfileSNR:
    def __init__(self, signal_to_noise_ratio=10.0):
        """
    ...
    def set_intensity_from(self, grid, exposure_time, background_sky_level=0.0):
        """
        ...
        intensity_factor = root_scalar(func, bracket=[1e-08, 100000000.0]).root
...
class SphGaussian(lp.SphGaussian, LightProfileSNR):
    def __init__(self, signal_to_noise_ratio=10.0, centre=(0.0, 0.0), sigma=0.01):
        """
