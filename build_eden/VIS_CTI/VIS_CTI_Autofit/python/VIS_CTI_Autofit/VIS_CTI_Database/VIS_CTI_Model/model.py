...
import numpy as np
from VIS_CTI_Autoconf.class_path import get_class, get_class_path
from VIS_CTI_Autofit.VIS_CTI_Database.sqlalchemy_ import sa, declarative
...
class Object(Base):
    ...
    def from_object(cls, source, name=""):
        ...
        if (source is None) or isinstance(
            ...
            from VIS_CTI_Autofit.VIS_CTI_Database.VIS_CTI_Model.instance import (
                NoneInstance,
            )
            ...
            instance = PriorModel._from_object(source)
            ...
            instance = CollectionPriorModel._from_object(source)
