...
from VIS_CTI_Autofit.VIS_CTI_Mapper.VIS_CTI_Prior import abstract
from VIS_CTI_Autofit.VIS_CTI_Mapper.VIS_CTI_PriorModel import prior_model
from VIS_CTI_Autofit.VIS_CTI_Mapper.VIS_CTI_PriorModel import collection
from VIS_CTI_Autofit.VIS_CTI_Database.VIS_CTI_Model.model import Object
...
class CollectionPriorModel(Object):
    ...
    def _from_object(cls, source):
        instance = cls()
        if not isinstance(source, collection.CollectionPriorModel):
            source = collection.CollectionPriorModel(source)
