...
from VIS_CTI_Autofit.VIS_CTI_Mapper.model_object import Identifier
...
class Scraper:
    ...
    def _fits(self):
        ...
        from VIS_CTI_Autofit.VIS_CTI_Aggregator.aggregator import (
        ...
        for item in aggregator:
            ...
            logger.info(
                f"Creating fit for: {item.search.unique_tag} {item.search.name} {identifier} "
            )
            try:
