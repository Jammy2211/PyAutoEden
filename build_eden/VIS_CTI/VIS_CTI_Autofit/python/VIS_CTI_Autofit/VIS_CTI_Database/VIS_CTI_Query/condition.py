...
from VIS_CTI_Autofit.VIS_CTI_Database.VIS_CTI_Model import get_class_path
...
class AbstractCondition(ABC):
    ...
    def __and__(self, other):
        ...
        """
        from VIS_CTI_Autofit.VIS_CTI_Database.VIS_CTI_Query.junction import And
    ...
    def __or__(self, other):
        ...
        Simplification is applied so that the query will execute as fast as possible.
        """
        from VIS_CTI_Autofit.VIS_CTI_Database.VIS_CTI_Query.junction import Or
