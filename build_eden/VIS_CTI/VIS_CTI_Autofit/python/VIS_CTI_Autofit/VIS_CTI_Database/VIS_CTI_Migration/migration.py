...
from VIS_CTI_Autofit.VIS_CTI_Database.VIS_CTI_Migration.session_wrapper import (
    SessionWrapper,
)
...
class Revision(Identifiable):
    ...
    def id(self):
        ...
        """
        return md5(
            ":".join((step.id for step in self.steps)).encode("utf-8")
        ).hexdigest()
    ...
    def __sub__(self, other):
        ...
        """
        return Revision(
            tuple((step for step in self.steps if (step not in other.steps)))
        )
