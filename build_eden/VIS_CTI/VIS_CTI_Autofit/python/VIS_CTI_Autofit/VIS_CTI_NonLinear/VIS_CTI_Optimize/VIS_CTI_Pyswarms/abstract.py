...
from VIS_CTI_Autofit.VIS_CTI_NonLinear.VIS_CTI_Optimize.VIS_CTI_Pyswarms.samples import (
    PySwarmsSamples,
)
from VIS_CTI_Autofit.VIS_CTI_Plot import PySwarmsPlotter
...
class AbstractPySwarms(AbstractOptimizer):
    ...
    def _fit(self, model, analysis, log_likelihood_cap=None):
        ...
        vector_lower = model.vector_from_unit_vector(
            unit_vector=([1e-06] * model.prior_count), ignore_prior_limits=True
        )
