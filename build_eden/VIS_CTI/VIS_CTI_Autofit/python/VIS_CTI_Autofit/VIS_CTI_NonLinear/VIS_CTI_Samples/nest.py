...
from VIS_CTI_Autofit.VIS_CTI_NonLinear.VIS_CTI_Samples.samples import Sample
from VIS_CTI_Autofit.VIS_CTI_NonLinear.VIS_CTI_Samples.stored import StoredSamples
...
class NestSamples(PDFSamples):
    ...
    def samples_within_parameter_range(self, parameter_index, parameter_range):
        """
