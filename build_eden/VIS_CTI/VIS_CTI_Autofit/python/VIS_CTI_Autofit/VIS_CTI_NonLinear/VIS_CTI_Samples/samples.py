...
class Samples:
    ...
    def max_log_likelihood_sample(self):
        ...
        for sample in self.sample_list:
            if (most_likely_sample is None) or (
                sample.log_likelihood > most_likely_sample.log_likelihood
            ):
                most_likely_sample = sample
        return most_likely_sample

    @property
    def max_log_posterior_sample(self):
    ...
    def max_log_likelihood_instance(self):
        ...
        """
        return self.max_log_likelihood_sample.instance_for_model(self.model)

    @property
    def max_log_posterior_index(self):
        """
    ...
    @property
    def max_log_posterior_vector(self):
        """
    ...
    @property
    def max_log_posterior_instance(self):
        """
