...
from VIS_CTI_Autofit.VIS_CTI_NonLinear.VIS_CTI_Samples.sample import (
    Sample,
    load_from_table,
)
from VIS_CTI_Autofit.VIS_CTI_NonLinear.VIS_CTI_Samples.samples import Samples
...
class PDFSamples(Samples):
    ...
    def from_table(cls, filename, model, number_live_points=None):
        ...
        """
        from VIS_CTI_Autofit.VIS_CTI_NonLinear.VIS_CTI_Samples.stored import (
            StoredSamples,
        )

        sample_list = load_from_table(filename=filename)
        return StoredSamples(model=model, sample_list=sample_list)
    ...
    def error_magnitude_vector_at_sigma(self, sigma):
        """
    ...
    def log_likelihood_from_sample_index(self, sample_index):
        """
    ...
    def vector_drawn_randomly_from_pdf(self):
        """
    ...
    def instance_drawn_randomly_from_pdf(self):
        """
