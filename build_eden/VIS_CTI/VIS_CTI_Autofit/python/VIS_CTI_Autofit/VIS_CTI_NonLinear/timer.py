...
class Timer:
    ...
    def update(self):
        ...
        try:
            execution_time = str(
                dt.timedelta(seconds=(time.time() - float(self.start_time)))
            )
        except TypeError:
            return
        with open(path.join(self.samples_path, ".time"), "w+") as f:
    ...
    def start_time(self):
        ...
        try:
            with open(path.join(self.samples_path, ".start_time"), "r") as f:
                return f.read()
        except FileNotFoundError:
            return None
    ...
    def time(self):
        ...
        try:
            with open(path.join(self.samples_path, ".time"), "r") as f:
                return f.read()
        except FileNotFoundError:
            return None
