...
from VIS_CTI_Autofit.VIS_CTI_NonLinear.VIS_CTI_Mcmc.abstract_mcmc import AbstractMCMC
from VIS_CTI_Autofit.VIS_CTI_NonLinear.VIS_CTI_Mcmc.auto_correlations import (
    AutoCorrelationsSettings,
)
from VIS_CTI_Autofit.VIS_CTI_NonLinear.VIS_CTI_Mcmc.VIS_CTI_Zeus.samples import (
    ZeusSamples,
)
...
from VIS_CTI_Autofit.VIS_CTI_NonLinear.VIS_CTI_Mcmc.VIS_CTI_Zeus.plotter import (
    ZeusPlotter,
)
...
class Zeus(AbstractMCMC):
    ...
    def __init__(
        ...
        *Attribution* section of the GitHub page.
        ...
        self.number_of_cores = number_of_cores or self._config(
