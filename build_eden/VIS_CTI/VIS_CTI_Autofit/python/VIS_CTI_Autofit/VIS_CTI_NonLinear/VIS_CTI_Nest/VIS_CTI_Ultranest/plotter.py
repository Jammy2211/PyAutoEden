...
class UltraNestPlotter(SamplesPlotter):
    def cornerplot(self, **kwargs):
        ...
        plot.cornerplot(results=self.samples.results_internal, **kwargs)
    ...
    def runplot(self, **kwargs):
        ...
        try:
            plot.runplot(results=self.samples.results_internal, **kwargs)
        except KeyError:
            pass
    ...
    def traceplot(self, **kwargs):
        ...
        try:
            plot.traceplot(results=self.samples.results_internal, **kwargs)
        except KeyError:
            pass
