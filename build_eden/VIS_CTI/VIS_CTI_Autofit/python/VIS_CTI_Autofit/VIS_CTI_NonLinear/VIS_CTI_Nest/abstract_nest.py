...
from VIS_CTI_Autofit.VIS_CTI_NonLinear.abstract_search import IntervalCounter
...
class AbstractNest(NonLinearSearch):
    ...
    class Fitness(NonLinearSearch.Fitness):
        def __init__(
            ...
            self.resampling_figure_of_merit = -1e99
        ...
        def stagger_resampling_figure_of_merit(self):
            ...
            elif self.stagger_accepted_samples < 10:
    ...
    def fitness_function_from_model_and_analysis(
        ...
        return self.__class__.Fitness(
            ...
            stagger_resampling_likelihood=self.config_dict_settings[
                "stagger_resampling_likelihood"
            ],
            log_likelihood_cap=log_likelihood_cap,
        )
