...
from VIS_CTI_Autofit.VIS_CTI_NonLinear.VIS_CTI_Nest.VIS_CTI_Dynesty.plotter import (
    DynestyPlotter,
)
...
class AbstractDynesty(AbstractNest, ABC):
    ...
    def live_points_from_model_and_fitness_function(self, model, fitness_function):
        (
            unit_parameters,
            parameters,
            log_likelihood_list,
