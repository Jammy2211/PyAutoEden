...
from VIS_CTI_Autofit.VIS_CTI_NonLinear.VIS_CTI_Samples.nest import NestSamples
...
class MultiNestSamples(NestSamples):
    ...
    def total_samples(self):
        return total_samples_from_file_resume(file_resume=self.file_resume)
...
def parameters_from_file_weighted_samples(file_weighted_samples, prior_count):
...
def log_likelihood_list_from_file_weighted_samples(file_weighted_samples):
...
def weight_list_from_file_weighted_samples(file_weighted_samples):
