...
class TransformedWrapperInstance(Prior):
    ...
    def __init__(self, transformed_wrapper, *args, **kwargs):
        """
        Parameters
        ----------
        transformed_wrapper
        ...
        kwargs
            ...
            class
        """
        super().__init__(id_=kwargs.get("id_"))
        self.transformed_wrapper = transformed_wrapper
        self.args = args
        self.kwargs = kwargs
        self._instance = None

    def project(self, samples, log_weight_list=None, id_=None):
        return self._new_for_base_message(
            self.transformed_wrapper.project(
                samples=samples, log_weight_list=log_weight_list, id_=id_
            )
        )
    ...
    def from_mode(self, mode, covariance, id_=None):
        return self._new_for_base_message(
            self.transformed_wrapper.from_mode(mode, covariance, id_=id_)
        )
...
class TransformedWrapper:
    ...
    def __init__(self, cls, transform, clsname=None, support=None):
        """
        Parameters
        ----------
        cls
    ...
    def transformed(self, transform, clsname=None, support=None, wrapper_cls=None):
        """
    ...
    def shifted(self, shift=0, scale=1, wrapper_cls=None):
    ...
    def _transformed_class(self):
        ...
        """
        from VIS_CTI_Autofit.VIS_CTI_Messages.transformed import TransformedMessage
        ...
        if isinstance(self.cls, TransformedWrapper):
            ...
            class Transformed(TransformedMessage):
                __qualname__ = clsname
        ...
        support = (
            (
                ...
                or tuple(
                    zip(
                        *map(
                            self.transform.inv_transform,
                            map(np.array, zip(*cls._support)),
                        )
                    )
                )
            )
