...
class AttributePredicate:
    ...
    def value_for_search_output(self, search_output):
        """
    ...
    def __eq__(self, value):
        ...
        """
        return EqualityPredicate(self, value)

    def __le__(self, other):
        return OrPredicate((self == other), (self < other))
    ...
    def __getattr__(self, item):
        ...
        """
        return AttributePredicate(*self.path, item)
    ...
    def __gt__(self, other):
        ...
        other value?
        """
        return GreaterThanPredicate(self, other)
    ...
    def __lt__(self, other):
        ...
        other value?
        """
        return LessThanPredicate(self, other)
    ...
    def contains(self, value):
        ...
        the attribute of a search.
        """
        return ContainsPredicate(self, value)
...
class AbstractPredicate(ABC):
    ...
    def filter(self, search_outputs):
        """
        ...
        """
        return filter((lambda search_output: self(search_output)), search_outputs)
...
class ComparisonPredicate(AbstractPredicate, ABC):
    def __init__(self, attribute_predicate, value):
        """
    ...
    def value(self, search_output):
        if isinstance(self._value, AttributePredicate):
            return self._value.value_for_search_output(search_output)
        return self._value
...
class ContainsPredicate(ComparisonPredicate):
    def __call__(self, search_output):
        ...
        return self.value(
            search_output
        ) in self.attribute_predicate.value_for_search_output(search_output)
...
class EqualityPredicate(ComparisonPredicate):
    def __call__(self, search_output):
        ...
        """
        try:
            value = self.value(search_output)
        except AttributeError:
            value = self.value
        return self.attribute_predicate.value_for_search_output(search_output) == value
...
class NotPredicate(AbstractPredicate):
    ...
    def __call__(self, search_output):
        ...
        """
        return not self.predicate(search_output)
