...
class Identifier:
    def __init__(self, obj, version=None):
        ...
        """
        self._identifier_version = (
            version or conf.instance["general"]["output"]["identifier_version"]
        )
        self.hash_list = list()
...
""".join(
    ...
    def _add_value_to_hash_list(self, value):
        ...
        if hasattr(value, "__dict__"):
            ...
            def _assert_fields_exist(attribute):
                fields_ = getattr(value, attribute)
                missing_fields = [field for field in fields_ if (field not in d)]
...
{string}"""
            ...
            if hasattr(value, "__identifier_fields__"):
                _assert_fields_exist("__identifier_fields__")
                ...
                if (self._identifier_version >= 4) and hasattr(
                    value, "__exclude_identifier_fields__"
                ):
                    _assert_fields_exist("__exclude_identifier_fields__")
