...
from VIS_CTI_Autofit.VIS_CTI_Graphical.VIS_CTI_Declarative.VIS_CTI_Factor.abstract import (
    AbstractModelFactor,
)


class HierarchicalFactor(PriorModel):
    def __init__(self, distribution, optimiser=None, name=None, **kwargs):
        """
    ...
    def add_drawn_variable(self, prior):
        """
...
class _HierarchicalFactor(AbstractModelFactor):
    def __init__(self, distribution_model, drawn_prior):
        """
    ...
    def log_likelihood_function(self, instance):
        return instance.distribution_model(instance.drawn_prior)[0]
