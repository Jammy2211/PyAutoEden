...
import yaml
from VIS_CTI_Autoconf.directory_config import (
    RecursiveConfig,
    PriorConfigWrapper,
    AbstractConfig,
    family,
)
from VIS_CTI_Autoconf.VIS_CTI_JsonPrior.config import JSONPriorConfig
...
class Config:
    ...
    def push(self, new_path, output_path=None, keep_first=False):
        """
...
default = Config((current_directory / "config"), (current_directory / "output/"))
instance = default
