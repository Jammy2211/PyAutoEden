...
from VIS_CTI_Autoarray.VIS_CTI_Structures.VIS_CTI_Arrays.VIS_CTI_OneD.abstract_array_1d import (
    AbstractArray1D,
)
...
class Array1D(AbstractArray1D):
    def __new__(cls, array, mask, header=None, *args, **kwargs):
        obj = array.view(cls)
        obj.mask = mask
        obj.header = header
        return obj
    ...
    @classmethod
    def manual_slim(cls, array, pixel_scales, sub_size=1, origin=(0.0,), header=None):
        """
    ...
    @classmethod
    def manual_native(cls, array, pixel_scales, sub_size=1, origin=(0.0,), header=None):
        """
        Create a Line (see `Line.__new__`) by inputting the line values in 1D, for example:
    ...
    @classmethod
    def zeros(cls, shape_native, pixel_scales, sub_size=1, origin=(0.0,), header=None):
        """
    ...
    @classmethod
    def ones(cls, shape_native, pixel_scales, sub_size=1, origin=(0.0,), header=None):
        """
