import logging
import numpy as np
from VIS_CTI_Autoarray.VIS_CTI_Structures.VIS_CTI_Arrays.VIS_CTI_TwoD.abstract_array_2d import (
    AbstractArray2D,
)
from VIS_CTI_Autoarray.VIS_CTI_Mask.mask_2d import Mask2D
from VIS_CTI_Autoarray import exc
from VIS_CTI_Autoarray.VIS_CTI_Structures.VIS_CTI_Arrays import abstract_array
...
class Array2D(AbstractArray2D):
    def __new__(cls, array, mask, header=None, zoom_for_plot=True, *args, **kwargs):
        ...
        Below is a visual illustration of a array, where a total of 10 pixels are unmasked and are included in         the array.
    ...
    @classmethod
    def manual_native(
        cls, array, pixel_scales, sub_size=1, origin=(0.0, 0.0), header=None
    ):
        """
    ...
    @classmethod
    def ones(
        cls, shape_native, pixel_scales, sub_size=1, origin=(0.0, 0.0), header=None
    ):
        """
    ...
    def manual_yx_and_values(
        cls, y, x, values, shape_native, pixel_scales, sub_size=1, header=None
    ):
        """
