...
from VIS_CTI_Autoarray.VIS_CTI_Mask.mask_2d import mask_2d_util
from VIS_CTI_Autoarray.VIS_CTI_Structures.VIS_CTI_Grids.VIS_CTI_TwoD import sparse_util
...
class Grid2D(AbstractGrid2D):
    ...
    def grid_with_coordinates_within_distance_removed(self, coordinates, distance):
    ...
    def structure_2d_from(self, result):
        ...
        """
        from VIS_CTI_Autoarray.VIS_CTI_Structures.VIS_CTI_Grids.VIS_CTI_TwoD.grid_transformed import (
            Grid2DTransformed,
        )
        from VIS_CTI_Autoarray.VIS_CTI_Structures.VIS_CTI_Grids.VIS_CTI_TwoD.grid_transformed import (
