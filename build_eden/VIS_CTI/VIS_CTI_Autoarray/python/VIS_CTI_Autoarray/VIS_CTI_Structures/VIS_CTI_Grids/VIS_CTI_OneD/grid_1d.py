...
from VIS_CTI_Autoarray.VIS_CTI_Structures.VIS_CTI_Grids.VIS_CTI_OneD import grid_1d_util
...
class Grid1D(AbstractGrid1D):
    ...
    @classmethod
    def uniform_from_zero(cls, shape_native, pixel_scales, sub_size=1):
        """
        Create a `Grid1D` (see `Grid`D.__new__`) as a uniform grid of (x) values given an input `shape_native` and
