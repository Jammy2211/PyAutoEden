...
from VIS_CTI_Autoarray.VIS_CTI_Mask.abstract_mask import AbstractMask
...
class AbstractMask2D(AbstractMask):
    def __new__(
        cls, mask, pixel_scales, sub_size=1, origin=(0.0, 0.0), *args, **kwargs
    ):
        """
    ...
    def resized_mask_from(self, new_shape, pad_value=0.0):
        """
...
class Mask2D(AbstractMask2D):
    @classmethod
    def manual(cls, mask, pixel_scales, sub_size=1, origin=(0.0, 0.0), invert=False):
        """
    ...
    @classmethod
    def unmasked(
        cls, shape_native, pixel_scales, sub_size=1, origin=(0.0, 0.0), invert=False
    ):
        """
