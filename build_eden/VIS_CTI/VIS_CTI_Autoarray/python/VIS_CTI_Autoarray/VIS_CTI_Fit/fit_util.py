...
def residual_map_from(*, data: np.ndarray, model_data: np.ndarray):
    """
...
def normalized_residual_map_from(*, residual_map: np.ndarray, noise_map: np.ndarray):
    """
...
def chi_squared_map_from(*, residual_map: np.ndarray, noise_map: np.ndarray):
    """
...
def chi_squared_from(*, chi_squared_map: np.ndarray):
    """
...
def noise_normalization_from(*, noise_map: np.ndarray):
    """
...
def chi_squared_with_mask_from(*, chi_squared_map: np.ndarray, mask: np.ndarray):
    """
...
def noise_normalization_with_mask_from(*, noise_map: np.ndarray, mask: np.ndarray):
    """
