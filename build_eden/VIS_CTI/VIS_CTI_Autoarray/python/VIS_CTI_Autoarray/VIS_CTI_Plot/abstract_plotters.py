...
from VIS_CTI_Autoarray.VIS_CTI_Plot.VIS_CTI_MatWrap.get_visuals import GetVisuals1D
from VIS_CTI_Autoarray.VIS_CTI_Plot.VIS_CTI_MatWrap.get_visuals import GetVisuals2D
...
class AbstractPlotter:
    ...
    def open_subplot_figure(
        ...
        as_subplot : bool
            If the figure is a subplot, the setup_figure function is omitted to ensure that each subplot does not create a             new figure and so that it can be output using the *output.output_figure(structure=None)* function.
        """
