...
from VIS_CTI_Autoarray.VIS_CTI_Inversion.VIS_CTI_Inversion.abstract import (
    AbstractInversion,
)
...
class InversionMatrices(AbstractInversion):
    ...
    def curvature_matrix(self):
        ...
        array of memory.
        """
        if (self.preloads.curvature_matrix_preload is None) or (
            not self.settings.use_curvature_matrix_preload
        ):
