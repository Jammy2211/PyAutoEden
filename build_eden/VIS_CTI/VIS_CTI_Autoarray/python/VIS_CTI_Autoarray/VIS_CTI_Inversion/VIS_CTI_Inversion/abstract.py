...
from VIS_CTI_Autoarray.VIS_CTI_Inversion.VIS_CTI_Inversion import inversion_util
...
class AbstractInversion:
    ...
    @cached_property
    @profile_func
    def mapped_reconstructed_data(self):
        """
        Using the reconstructed source pixel fluxes we map each source pixel flux back to the image plane and
        reconstruct the image data.
    ...
    @property
    def regularization_weights_mapper_dict(self):
    ...
    @property
    def residual_map_mapper_dict(self):
        return {
    ...
    @property
    def normalized_residual_map_mapper_dict(self):
        return {
    ...
    @property
    def chi_squared_map_mapper_dict(self):
        return {
