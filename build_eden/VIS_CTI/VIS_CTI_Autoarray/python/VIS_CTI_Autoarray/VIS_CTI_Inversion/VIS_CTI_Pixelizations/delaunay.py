...
from VIS_CTI_Autoarray.VIS_CTI_Inversion.VIS_CTI_Pixelizations.abstract import (
...
class DelaunayMagnification(Delaunay):
    ...
    def data_pixelization_grid_from(
        self, data_grid_slim, hyper_image=None, settings=SettingsPixelization()
    ):
        """
...
class DelaunayBrightnessImage(Delaunay):
    ...
    def weight_map_from(self, hyper_image):
        """
