...
from VIS_CTI_Autoarray.VIS_CTI_Inversion.linear_obj import UniqueMappings
...
from VIS_CTI_Autoarray.VIS_CTI_Inversion.VIS_CTI_Mappers import mapper_util
...
class AbstractMapper(LinearObj):
    ...
    @cached_property
    def pix_sizes_for_sub_slim_index(self):
        """
...
class PixSubWeights:
    def __init__(self, mappings, sizes, weights):
        """
