...
from SLE_Model_Autogalaxy.SLE_Model_Profiles.SLE_Model_Light.SLE_Model_Snr import (
    LightProfileSNR,
)
...
class Tracer(ABC, ag.OperateImageGalaxies, ag.OperateDeflections, Dictable):
    def __init__(self, planes, cosmology, profiling_dict=None):
        """
        ...
        border : masks.GridBorder
            The border of the grid, which is used to relocate demagnified traced pixels to the             source-plane borders.
    ...
    def grid_2d_at_redshift_from(self, grid, redshift):
        """
