...
class SubhaloGridSearchResult(af.GridSearchResult):
    ...
    def _array_2d_from(self, values):
        """
    ...
    def figure_of_merit_array(
        self, use_log_evidences=True, relative_to_value=0.0, remove_zeros=False
    ):
        """
...
class SubhaloPlotter(AbstractPlotter):
    ...
    @property
    def fit_imaging_with_subhalo_plotter(self):
        """
    ...
    def fit_imaging_with_subhalo_plotter_from(self, visuals_2d):
        """
    ...
    def set_auto_filename(self, filename, use_log_evidences=None):
        """
    ...
    def figure_figures_of_merit_grid(
        ...
        reset_filename = self.set_auto_filename(
            filename="subhalo_grid", use_log_evidences=use_log_evidences
        )
