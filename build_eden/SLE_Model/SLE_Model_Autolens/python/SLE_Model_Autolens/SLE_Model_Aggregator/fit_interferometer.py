...
from SLE_Model_Autogalaxy.SLE_Model_Aggregator.SLE_Model_Interferometer.interferometer import (
...
def _fit_interferometer_from(
    ...
    use_preloaded_grid
        ...
        as the fit.
    """
    dataset_list = _interferometer_from(fit=fit, real_space_mask=real_space_mask)
