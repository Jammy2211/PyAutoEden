...
from SLE_Model_Autogalaxy.SLE_Model_Aggregator.SLE_Model_Imaging.imaging import (
    _imaging_from,
)
from SLE_Model_Autogalaxy.SLE_Model_Aggregator.dataset_model import _dataset_model_from
from SLE_Model_Autogalaxy.SLE_Model_Aggregator import agg_util
from SLE_Model_Autolens.SLE_Model_Aggregator.tracer import _tracer_from


def _fit_imaging_from(
    fit, instance=None, settings_inversion=None, use_preloaded_grid=True
):
    """
...
class FitImagingAgg(af.AggBase):
    def __init__(self, aggregator, settings_inversion=None, use_preloaded_grid=True):
        """
