...
from SLE_Model_Autogalaxy.SLE_Model_Analysis.visualizer import plot_setting
from SLE_Model_Autogalaxy.SLE_Model_Analysis.visualizer import (
    Visualizer as AgVisualizer,
)
...
class Visualizer(AgVisualizer):
    ...
    def visualize_image_with_positions(self, image, positions):
        """
    ...
    def visualize_stochastic_histogram(
        self, stochastic_log_likelihoods, max_log_evidence, histogram_bins=10
    ):
        """
