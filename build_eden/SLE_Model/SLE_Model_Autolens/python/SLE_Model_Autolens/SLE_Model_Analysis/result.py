...
class Result(AgResult):
    ...
    @property
    def source_plane_light_profile_centre(self):
        """
    ...
    @property
    def image_plane_multiple_image_positions(self):
        """
    ...
    def positions_threshold_from(
        self, factor=1.0, minimum_threshold=None, positions=None
    ):
        """
    ...
    def positions_likelihood_from(
        self, factor=1.0, minimum_threshold=None, use_resample=False, positions=None
    ):
...
class ResultDataset(Result):
    ...
    @property
    def source_plane_inversion_centre(self):
        """
