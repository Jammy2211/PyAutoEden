...
from SLE_Model_Autofit.SLE_Model_Graphical.utils import rescale_to_artists
...
{results_text}"""
    ...
    def func_jacobian(self, variable_dict, **kwargs):
        log_value = 0.0
        det_values = {}
        factor_jacs = {}
        variables = {**self.fixed_values, **variable_dict}
        ...
        graph_vjp = VectorJacobianProduct(
            jac_out, graph_vjp, *jac_variables, out_shapes=fval.to_dict().shapes
        )
