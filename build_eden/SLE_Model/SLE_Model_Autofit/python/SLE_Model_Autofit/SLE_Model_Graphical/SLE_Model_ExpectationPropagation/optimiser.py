...
from SLE_Model_Autofit.SLE_Model_Graphical.SLE_Model_ExpectationPropagation.factor_optimiser import (
    AbstractFactorOptimiser,
    ExactFactorFit,
)
from SLE_Model_Autofit.SLE_Model_Graphical.SLE_Model_ExpectationPropagation.visualise import (
    Visualise,
)
...
class ApproxUpdater(ABC):
    ...
    def update_model_approx(
        self, new_model_dist, factor_approx, model_approx, status=Status()
    ):
