...
class Timer:
    def __init__(self, timer_path):
        ...
        os.makedirs(timer_path, exist_ok=True)
    ...
    def update(self):
        ...
        try:
            ...
            return
        with open((self.timer_path / ".time"), "w+") as f:
    ...
    def start_time(self):
        ...
        """
        try:
            with open((self.timer_path / ".start_time"), "r") as f:
                return f.read()
        except FileNotFoundError:
            return None
    ...
    def time(self):
        ...
        """
        try:
            with open((self.timer_path / ".time"), "r") as f:
                return f.read()
        except FileNotFoundError:
            return None
