...
from SLE_Model_Autofit.SLE_Model_NonLinear.SLE_Model_Optimize.abstract_optimize import (
    AbstractOptimizer,
)
from SLE_Model_Autofit.SLE_Model_NonLinear.abstract_search import Analysis
from SLE_Model_Autofit.SLE_Model_NonLinear.abstract_search import PriorPasser
from SLE_Model_Autofit.SLE_Model_NonLinear.initializer import AbstractInitializer
from SLE_Model_Autofit.SLE_Model_NonLinear.SLE_Model_Optimize.SLE_Model_Lbfgs.samples import (
    SamplesLBFGS,
)
import copy
...
class LBFGS(AbstractOptimizer):
    ...
    def _fit(self, model, analysis, log_likelihood_cap=None):
        ...
        maxiter = self.config_dict_options.get("maxiter", 100000000.0)
