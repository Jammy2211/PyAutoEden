...
from SLE_Model_Autofit.SLE_Model_NonLinear.SLE_Model_Parallel import (
    AbstractJob,
    Process,
    AbstractJobResult,
)
...
class AnalysisFactory:
    def __init__(self, instance, simulate_function, analysis_class, paths):
        """
