...
class Sample:
    def __init__(self, log_likelihood, log_prior, weight, kwargs=None):
        """
    ...
    def parameter_lists_for_model(self, model):
        """
    ...
    @classmethod
    def from_lists(
        cls, model, parameter_lists, log_likelihood_list, log_prior_list, weight_list
    ):
        """
