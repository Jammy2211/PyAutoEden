...
from SLE_Model_Autofit.SLE_Model_Database.SLE_Model_Model import get_class_path
...
class AbstractCondition(ABC):
    ...
    def __and__(self, other):
        ...
        """
        from SLE_Model_Autofit.SLE_Model_Database.SLE_Model_Query.junction import And
    ...
    def __or__(self, other):
        ...
        Simplification is applied so that the query will execute as fast as possible.
        """
        from SLE_Model_Autofit.SLE_Model_Database.SLE_Model_Query.junction import Or
