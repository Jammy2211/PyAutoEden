...
from SLE_Model_Autofit.SLE_Model_Database.SLE_Model_Aggregator import *
from SLE_Model_Autofit.SLE_Model_Database.SLE_Model_Migration.steps import migrator
from SLE_Model_Autofit.SLE_Model_Database.SLE_Model_Model import *


def open_database(filename="database.sqlite"):
    """
    ...
    if filename.endswith(".sqlite"):
        ...
        kwargs = dict(connect_args={"timeout": 15})
    else:
        string = filename
        kwargs = dict()
        exists = True
    engine = sa.create_engine(string, **kwargs)
