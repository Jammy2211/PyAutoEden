...
class AbstractModel(ModelObject):
    ...
    def path_instance_tuples_for_class(
        self, cls, ignore_class=None, ignore_children=True
    ):
        """
    ...
    @frozen_cache
    def models_with_type(self, cls, include_zero_dimension=False):
        """
...
@DynamicRecursionCache()
def path_instances_of_class(obj, cls, ignore_class=None, ignore_children=False):
    """
...
class ModelInstance(AbstractModel):
    ...
    def as_model(self, model_classes=tuple(), excluded_classes=tuple()):
        """
