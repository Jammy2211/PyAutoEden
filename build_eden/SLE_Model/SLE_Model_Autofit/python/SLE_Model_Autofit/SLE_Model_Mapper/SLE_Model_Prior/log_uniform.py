...
from SLE_Model_Autofit.SLE_Model_Messages.transform import (
    log_10_transform,
...
class LogUniformPrior(Prior):
    def __init__(self, lower_limit=1e-06, upper_limit=1.0, id_=None):
        """
    ...
    def with_limits(cls, lower_limit, upper_limit):
        ...
        A new LogUniform.
        """
        return cls(lower_limit=max(1e-06, lower_limit), upper_limit=upper_limit)
