...
from SLE_Model_Autofit.SLE_Model_Tools.util import split_paths
...
{exception}"""
    ...
    def random_vector_from_priors_within_limits(self, lower_limit=0.0, upper_limit=1.0):
        """
    ...
    def random_instance_from_priors_within_limits(
        self, lower_limit=0.0, upper_limit=1.0
    ):
        """
    ...
    def has_model(self, cls, include_zero_dimension=False):
        """
    ...
    @staticmethod
    @DynamicRecursionCache()
    def from_instance(instance, model_classes=tuple(), exclude_classes=tuple()):
        """
    ...
    def all_paths_for_prior(self, prior):
        """
...
""".join(
    ...
    @property
    def parameter_labels_with_superscripts(self):
        """
