...
from SLE_Model_Autofit import ModelInstance
...
from SLE_Model_Autogalaxy.SLE_Model_Profiles.basis import Basis
...
class AbstractFitInversion:
    ...
    def galaxy_linear_obj_data_dict_from(self, use_image=False):
        """
