...
from SLE_Model_Autogalaxy.SLE_Model_Util import error_util
...
class GalaxyPlotter(Plotter):
    ...
    def light_profile_plotter_from(self, light_profile, one_d_only=False):
        """
    ...
    def mass_profile_plotter_from(self, mass_profile, one_d_only=False):
        """
    ...
    def decomposed_light_profile_plotter_list(self):
        plotter_list = []
        for (i, light_profile) in enumerate(
            self.galaxy.cls_list_from(cls=LightProfile)
        ):
