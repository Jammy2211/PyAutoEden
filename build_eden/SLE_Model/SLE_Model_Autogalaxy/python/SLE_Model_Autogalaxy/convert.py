...
def shear_gamma_1_2_from(magnitude, angle):
    """
...
def shear_magnitude_and_angle_from(gamma_1, gamma_2):
    """
...
def shear_magnitude_from(gamma_1, gamma_2):
    """
    Returns the shear magnitude and angle in degrees from input shear gamma 1 and gamma 2 values.
...
def shear_angle_from(gamma_1, gamma_2):
    """
    Returns the shear magnitude and angle in degrees from input shear gamma 1 and gamma 2 values.
...
def multipole_k_m_and_phi_m_from(multipole_comps, m):
    """
    ...
    """
    phi_m = (
        (np.arctan2(multipole_comps[0], multipole_comps[1]) * 180.0) / np.pi
    ) / float(m)
...
def multipole_comps_from(k_m, phi_m, m):
    """
