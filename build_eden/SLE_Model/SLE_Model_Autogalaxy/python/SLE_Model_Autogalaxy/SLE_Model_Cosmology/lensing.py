...
class LensingCosmology(cosmo.FLRW):
    ...
    def arcsec_per_kpc_from(self, redshift):
        """
    ...
    def angular_diameter_distance_to_earth_in_kpc_from(self, redshift):
        """
    ...
    def cosmic_average_density_from(self, redshift):
        """
    ...
    def cosmic_average_density_solar_mass_per_kpc3_from(self, redshift):
        """
    ...
    def critical_surface_density_between_redshifts_from(self, redshift_0, redshift_1):
        """
    ...
    def critical_surface_density_between_redshifts_solar_mass_per_kpc2_from(
        ...
        return (
            (const * angular_diameter_distance_of_redshift_1_to_earth_kpc)
            / (
                angular_diameter_distance_between_redshifts_kpc
                * angular_diameter_distance_of_redshift_0_to_earth_kpc
            )
    ...
    def scaling_factor_between_redshifts_from(
        self, redshift_0, redshift_1, redshift_final
    ):
        """
    ...
    def velocity_dispersion_from(self, redshift_0, redshift_1, einstein_radius):
        ...
        velocity_dispersion_kpc = const * np.sqrt(
            (
                ...
                / (
                    ((4 * np.pi) * angular_diameter_distance_to_redshift_0_kpc)
                    * angular_diameter_distance_between_redshifts_kpc
                )
            )
        )
