...
from SLE_Model_Autogalaxy.SLE_Model_Analysis.SLE_Model_Analysis.analysis import Analysis
...
from SLE_Model_Autogalaxy.SLE_Model_Quantity.SLE_Model_Model.result import (
    ResultQuantity,
)
from SLE_Model_Autogalaxy.SLE_Model_Quantity.SLE_Model_Model.visualizer import (
    VisualizerQuantity,
)
...
class AnalysisQuantity(Analysis):
    ...
    def __init__(self, dataset, func_str, cosmology=Planck15(), title_prefix=None):
        """
    ...
    def save_attributes(self, paths):
        ...
        """
        paths.save_fits(
            name="data", hdu=self.dataset.data.hdu_for_output, prefix="dataset"
        )
        paths.save_fits(
            name="noise_map",
        ...
        paths.save_json(name="cosmology", object_dict=to_dict(self.cosmology))
