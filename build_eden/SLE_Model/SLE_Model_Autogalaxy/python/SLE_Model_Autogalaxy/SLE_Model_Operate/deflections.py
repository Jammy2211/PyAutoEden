...
class OperateDeflections:
    ...
    def magnification_2d_from(self, grid):
        ...
        det_jacobian = (jacobian[0][0] * jacobian[1][1]) - (
    ...
    @evaluation_grid
    def radial_caustic_list_from(self, grid, pixel_scale=0.05):
        """
    ...
    @evaluation_grid
    def einstein_radius_list_from(self, grid, pixel_scale=0.05):
        """
    ...
    @evaluation_grid
    def einstein_mass_angular_list_from(self, grid, pixel_scale=0.05):
        """
