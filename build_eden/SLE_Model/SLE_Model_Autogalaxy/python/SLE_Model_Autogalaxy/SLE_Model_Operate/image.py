...
class OperateImage:
    ...
    @aa.profile_func
    def _blurred_image_2d_from(self, image_2d, blurring_image_2d, psf, convolver):
        if psf is not None:
            return psf.convolved_array_with_mask_from(
                array=(image_2d.native + blurring_image_2d.native), mask=image_2d.mask
            )
    ...
    def blurred_image_2d_from(self, grid, blurring_grid, psf=None, convolver=None):
        """
        ...
        """
        from SLE_Model_Autogalaxy.SLE_Model_Profiles.SLE_Model_Light.SLE_Model_Operated import (
    ...
    @aa.profile_func
    def visibilities_from(self, grid, transformer):
        """
...
class OperateImageList(OperateImage):
    ...
    def blurred_image_2d_list_from(self, grid, blurring_grid, psf=None, convolver=None):
        """
    ...
    def unmasked_blurred_image_2d_list_from(self, grid, psf):
        """
    ...
    def visibilities_list_from(self, grid, transformer):
        """
...
class OperateImageGalaxies(OperateImageList):
    ...
    def galaxy_image_2d_dict_from(self, grid, operated_only=None):
        raise NotImplementedError

    def galaxy_blurred_image_2d_dict_from(self, grid, convolver, blurring_grid):
        """
    ...
    def galaxy_visibilities_dict_from(self, grid, transformer):
        """
