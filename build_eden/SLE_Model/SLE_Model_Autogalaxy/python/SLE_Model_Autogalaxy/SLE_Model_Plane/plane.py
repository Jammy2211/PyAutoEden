...
from SLE_Model_Autogalaxy.SLE_Model_Plane import plane_util
...
class Plane(OperateImageGalaxies, OperateDeflections, Dictable):
    ...
    @property
    def adapt_galaxies_with_pixelization_image_list(self):
        return [
    ...
    def plane_image_2d_from(self, grid, zoom_to_brightest=True):
