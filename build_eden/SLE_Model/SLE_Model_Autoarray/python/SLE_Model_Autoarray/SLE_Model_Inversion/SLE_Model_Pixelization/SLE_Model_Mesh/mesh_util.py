...
@numba_util.jit()
def rectangular_corner_neighbors(neighbors, neighbors_sizes, shape_native):
    """
...
@numba_util.jit()
def rectangular_top_edge_neighbors(neighbors, neighbors_sizes, shape_native):
    """
    Updates the `neighbors` and `neighbors_sizes` arrays described in the function
...
@numba_util.jit()
def rectangular_left_edge_neighbors(neighbors, neighbors_sizes, shape_native):
    """
    Updates the `neighbors` and `neighbors_sizes` arrays described in the function
...
@numba_util.jit()
def rectangular_right_edge_neighbors(neighbors, neighbors_sizes, shape_native):
    """
    Updates the `neighbors` and `neighbors_sizes` arrays described in the function
...
@numba_util.jit()
def rectangular_bottom_edge_neighbors(neighbors, neighbors_sizes, shape_native):
    """
    Updates the `neighbors` and `neighbors_sizes` arrays described in the function
...
@numba_util.jit()
def rectangular_central_neighbors(neighbors, neighbors_sizes, shape_native):
    """
    Updates the `neighbors` and `neighbors_sizes` arrays described in the function
...
def rectangular_edge_pixel_list_from(neighbors):
    """
...
@numba_util.jit()
def delaunay_triangle_area_from(corner_0, corner_1, corner_2):
    """
...
def delaunay_interpolated_array_from(
    shape_native, interpolation_grid_slim, pixel_values, delaunay
):
    """
...
def voronoi_edge_pixels_from(regions, point_region):
    """
...
def voronoi_revised_from(voronoi):
    """
...
def voronoi_nn_interpolated_array_from(
    shape_native, interpolation_grid_slim, pixel_values, voronoi
):
    try:
