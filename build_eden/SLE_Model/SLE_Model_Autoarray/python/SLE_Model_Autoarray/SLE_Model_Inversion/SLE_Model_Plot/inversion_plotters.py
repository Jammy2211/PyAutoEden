...
class InversionPlotter(Plotter):
    ...
    def figures_2d(self, reconstructed_image=False):
        """
    ...
    def figures_2d_of_pixelization(
        ...
        data_subtracted=False,
        reconstructed_image=False,
        reconstruction=False,
        errors=False,
        regularization_weights=False,
        sub_pixels_per_image_pixels=False,
        mesh_pixels_per_image_pixels=False,
        image_pixels_per_mesh_pixel=False,
        magnification_per_mesh_pixel=False,
    ...
    def subplot_of_mapper(self, mapper_index=0, auto_filename="subplot_inversion"):
        """
    ...
    def subplot_mappings(self, pixelization_index=0, auto_filename="subplot_mappings"):
