...
def residual_map_from(*, data: Structure, model_data: Structure):
    """
...
def normalized_residual_map_from(*, residual_map: Structure, noise_map: Structure):
    """
...
def chi_squared_map_from(*, residual_map: Structure, noise_map: Structure):
    """
...
def chi_squared_from(*, chi_squared_map: Structure):
    """
...
def noise_normalization_from(*, noise_map: Structure):
    """
...
def chi_squared_map_complex_from(*, residual_map: Structure, noise_map: Structure):
    """
...
def chi_squared_complex_from(*, chi_squared_map: Structure):
    """
...
def noise_normalization_complex_from(*, noise_map: Structure):
    """
...
def residual_map_with_mask_from(*, data: Structure, mask: Mask, model_data: Structure):
    """
    Returns the residual-map of the fit of model-data to a masked dataset, where:
...
def chi_squared_with_mask_from(*, chi_squared_map: Structure, mask: Mask):
    """
...
def noise_normalization_with_mask_from(*, noise_map: Structure, mask: Mask):
    """
...
def chi_squared_complex_with_mask_from(*, chi_squared_map: Structure, mask: Mask):
    """
    Returns the chi-squared terms of each complex model data's fit to a masked dataset, by summing the masked
    chi-squared-map of the fit.
...
def noise_normalization_complex_with_mask_from(*, noise_map: Structure, mask: Mask):
    """
    ...
    return float(
        (
            ...
            * (
                (
                    (
                        (chi_squared + regularization_term)
                        + log_curvature_regularization_term
                    )
                    - log_regularization_term
                )
