...
if TYPE_CHECKING:
    ...
    from SLE_Model_Autoarray.type import Region2DLike
import SLE_Model_Autoarray as aa


def rotate_array_via_roe_corner_from(array, roe_corner):
    """
...
def rotate_region_via_roe_corner_from(region, shape_native, roe_corner):
    """
...
def rotate_pattern_ci_via_roe_corner_from(pattern_ci, shape_native, roe_corner):
    """
