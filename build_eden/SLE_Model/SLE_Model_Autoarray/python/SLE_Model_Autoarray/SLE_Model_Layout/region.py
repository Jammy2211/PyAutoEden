...
class Region1D(AbstractRegion):
    ...
    def front_region_from(self, pixels=None, pixels_from_end=None):
        """
    ...
    def trailing_region_from(self, pixels):
        """
...
class Region2D(AbstractRegion):
    ...
    def serial_x_front_range_from(self, pixels):
        """
    ...
    def parallel_front_region_from(self, pixels=None, pixels_from_end=None):
        """
    ...
    def parallel_trailing_region_from(self, pixels=(0, 1)):
        """
    ...
    def parallel_full_region_from(self, shape_2d):
        """
    ...
    def serial_front_region_from(self, pixels=None, pixels_from_end=None):
        """
    ...
    def serial_trailing_region_from(self, pixels=(0, 1)):
        """
    ...
    def serial_towards_roe_full_region_from(self, shape_2d, pixels=(0, 1)):
        """
