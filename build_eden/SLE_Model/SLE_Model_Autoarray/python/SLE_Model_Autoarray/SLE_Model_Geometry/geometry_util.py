...
def convert_pixel_scales_1d(pixel_scales):
    """
...
@numba_util.jit()
def central_pixel_coordinates_1d_from(shape_slim):
    """
...
@numba_util.jit()
def central_scaled_coordinate_1d_from(shape_slim, pixel_scales, origin=(0.0, 0.0)):
    """
...
def pixel_coordinates_1d_from(
    scaled_coordinates_1d, shape_slim, pixel_scales, origins=(0.0, 0.0)
):
    central_pixel_coordinates = central_pixel_coordinates_1d_from(shape_slim=shape_slim)
    x_pixel = int(
        (
...
def scaled_coordinates_1d_from(
    pixel_coordinates_1d, shape_slim, pixel_scales, origins=(0.0, 0.0)
):
...
@numba_util.jit()
def central_pixel_coordinates_2d_from(shape_native):
    """
...
@numba_util.jit()
def central_scaled_coordinate_2d_from(shape_native, pixel_scales, origin=(0.0, 0.0)):
    """
...
def pixel_coordinates_2d_from(
    scaled_coordinates_2d, shape_native, pixel_scales, origins=(0.0, 0.0)
):
    """
...
def scaled_coordinates_2d_from(
    pixel_coordinates_2d, shape_native, pixel_scales, origins=(0.0, 0.0)
):
    """
...
def transform_grid_2d_to_reference_frame(grid_2d, centre, angle):
    """
...
def transform_grid_2d_from_reference_frame(grid_2d, centre, angle):
    """
...
def extent_symmetric_from(extent):
    """
