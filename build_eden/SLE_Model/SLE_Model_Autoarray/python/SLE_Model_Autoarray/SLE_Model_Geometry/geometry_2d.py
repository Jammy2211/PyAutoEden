...
class Geometry2D(AbstractGeometry2D):
    def __init__(self, shape_native, pixel_scales, origin=(0.0, 0.0)):
        """
    ...
    def scaled_coordinate_2d_to_scaled_at_pixel_centre_from(self, scaled_coordinate_2d):
        """
    ...
    def grid_pixels_2d_from(self, grid_scaled_2d):
        """
    ...
    def grid_pixel_centres_2d_from(self, grid_scaled_2d):
        """
    ...
    def grid_pixel_indexes_2d_from(self, grid_scaled_2d):
        """
    ...
    def grid_scaled_2d_from(self, grid_pixels_2d):
        """
