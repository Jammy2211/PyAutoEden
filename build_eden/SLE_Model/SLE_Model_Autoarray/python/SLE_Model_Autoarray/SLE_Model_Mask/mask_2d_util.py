                    ...
                    for x1 in range(
                        ...
                        if (0 <= (x + x1) <= (mask_2d.shape[1] - 1)) and (
                            ...
                            raise exc.MaskException(
                                "setup_blurring_mask extends beyond the edge of the mask - pad the datas array before masking"
                            )
...
def rescaled_mask_2d_from(mask_2d, rescale_factor):
    ...
    try:
        ...
        rescaled_mask_2d = rescale(
            image=mask_2d, scale=rescale_factor, mode="edge", anti_aliasing=False
        )
...
@numba_util.jit()
def native_index_for_slim_index_2d_from(mask_2d):
    """
