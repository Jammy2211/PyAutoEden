...
from SLE_Model_Autoarray.SLE_Model_Plot.SLE_Model_Wrap import SLE_Model_OneD as w1d
...
class MatPlot1D(AbstractMatPlot):
    ...
    def plot_yx(
        ...
        from SLE_Model_Autoarray.SLE_Model_Plot.SLE_Model_Wrap.SLE_Model_Base.text import (
            Text,
        )
