...
class MultiFigurePlotter:
    def __init__(self, plotter_list, subplot_shape=None, subplot_title=None):
        """
    ...
    def setup_subplot_via_mat_plot(self, plotter, number_subplots, subplot_index):
        """
    ...
    def plot_via_func(self, plotter, figure_name, func_name, kwargs):
        """
    ...
    def output_subplot(self, filename_suffix=""):
        """
    ...
    def subplot_of_figures_multi(
        ...
        figure_name_list,
        filename_suffix="",
        subplot_index_offset=0,
        number_subplots=None,
        open_subplot=True,
        close_subplot=True,
        **kwargs,
    ):
        ...
        for (i, plotter) in enumerate(self.plotter_list):
            for (j, (func_name, figure_name)) in enumerate(
                ...
                subplot_index = (
                    (subplot_index_offset + (i * subplot_shape[1])) + j
                ) + 1
                self.setup_subplot_via_mat_plot(
                    plotter=plotter,
