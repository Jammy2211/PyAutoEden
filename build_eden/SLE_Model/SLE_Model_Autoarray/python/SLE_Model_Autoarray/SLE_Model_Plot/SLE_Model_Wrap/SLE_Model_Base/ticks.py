...
class TickMaker:
    def __init__(self, min_value, max_value, factor, number_of_ticks, units):
...
class AbstractTicks(AbstractMatWrap):
    ...
    def tick_maker_from(self, min_value, max_value, units, is_for_1d_plot):
    ...
    def ticks_from(
        self, min_value, max_value, units, is_log10=False, is_for_1d_plot=False
    ):
