...
def convert_grid_1d(grid_1d, mask_1d, store_native=False):
    """
    ...
    if is_native == store_native:
        ...
        return grid_1d_slim_from(grid_1d_native=grid_1d, mask_1d=np.array(mask_1d))
    return grid_1d_native_from(grid_1d_slim=grid_1d, mask_1d=np.array(mask_1d))


def grid_1d_slim_via_shape_slim_from(shape_slim, pixel_scales, origin=(0.0,)):
    """
...
@numba_util.jit()
def grid_1d_slim_via_mask_from(mask_1d, pixel_scales, origin=(0.0,)):
    """
...
def grid_1d_slim_from(grid_1d_native, mask_1d):
    """
    ...
    return array_1d_util.array_1d_slim_from(
        array_1d_native=np.array(grid_1d_native), mask_1d=mask_1d
    )


def grid_1d_native_from(grid_1d_slim, mask_1d):
    """
    ...
    return array_1d_util.array_1d_native_from(
        array_1d_slim=grid_1d_slim, mask_1d=mask_1d
    )
