...
from SLE_Model_Autoarray.SLE_Model_Mask.mask_2d import mask_2d_util
from SLE_Model_Autoarray.SLE_Model_Structures.SLE_Model_Grids import sparse_2d_util


class Grid2DSparse(Structure):
    def __new__(cls, values, sparse_index_for_slim_index):
        """
