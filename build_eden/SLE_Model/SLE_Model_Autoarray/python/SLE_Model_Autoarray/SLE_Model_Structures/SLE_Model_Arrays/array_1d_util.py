...
@numba_util.jit()
def array_1d_slim_from(array_1d_native, mask_1d, sub_size):
    """
...
def array_1d_native_from(array_1d_slim, mask_1d, sub_size):
...
def array_1d_via_indexes_1d_from(
    array_1d_slim, sub_shape, native_index_for_slim_index_1d
):
    """
