...
from SLE_Model_Autoconf.directory_config import NamedConfig
from SLE_Model_Autoconf.SLE_Model_Mock.mock_real import EllProfile, Gaussian
...
def make_label_config():
    return NamedConfig("{}/files/config/label.ini".format(directory))
